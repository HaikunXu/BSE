...
save(list=objects(pat="fishery.estimates.yft."),file=paste0(save_dir,"BET_",PS,"_1975-1999.RData"))
...
for(year in yr.start:yr.end) {
  ...
  print("Step 2: get catch estimates")
  if(year!=1988) catch.estimates <- get.catch.estimates.7599.f(cae,cae.stratflg,corrected.unlds,lfgrpd,lfmm,year,2,well.estimates,PS)
  else catch.estimates <- get.catch.estimates.7599.f(cae,cae.stratflg,corrected.unlds,lfgrpd,lfmm,year,1,well.estimates,PS)

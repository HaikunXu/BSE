...
get.catch.estimates.7599.f = function(cae.in,caestrtflg.in,totunlds.in,lfgrpd.in,lfmm.in,my.year,minsamps.in,well.estimates,PS,pre2000) {
  # single spp P-S
  ...
  tmpbet<-create.strat.flg.f(well.estimates$ancillary.info[[1]]$lat.5deg,well.estimates$ancillary.info[[1]]$lon.5deg,is.lwrght=T,well.estimates$ancillary.info[[1]]$month,well.estimates$ancillary.info[[1]]$setype,well.estimates$ancillary.info[[1]]$class,PS,"BET")
  tmpyft<-create.strat.flg.f(well.estimates$ancillary.info[[2]]$lat.5deg,well.estimates$ancillary.info[[2]]$lon.5deg,is.lwrght=T,well.estimates$ancillary.info[[2]]$month,well.estimates$ancillary.info[[2]]$setype,well.estimates$ancillary.info[[2]]$class,PS,"BET")
  tmpskj<-create.strat.flg.f(well.estimates$ancillary.info[[3]]$lat.5deg,well.estimates$ancillary.info[[3]]$lon.5deg,is.lwrght=T,well.estimates$ancillary.info[[3]]$month,well.estimates$ancillary.info[[3]]$setype,well.estimates$ancillary.info[[3]]$class,PS,"SKJ")
  well.stratflg<-list(bet=tmpbet,yft=tmpyft,skj=tmpskj)
  rm(list=c("tmpbet","tmpyft","tmpskj"))
  ...
  stratum.estimates.withsamps<-call.stratum.estimates.f(totunlds.bystrat,well.estimates,well.stratflg,minsamps.in)

...
fishery.substitution.mat <- matrix(paste0("FO.A", area.substitution.mat),ncol=ncol(area.substitution.mat)) # fishery and area definitions are identical
...
for(year in yr.start:yr.end) {
  ...
  catch.estimates <- get.catch.estimates.f(cae,cae.stratflg,total.unlds,lfgrpd,lfgrpd.stratflg,lfmm,year,2,well.estimates,area.substitution.mat,grow.increments,PS=PS,Species=Species,fishery.substitution.mat)
...
fishery.substitution.mat <- matrix(paste0("UN.A", area.substitution.mat),ncol=ncol(area.substitution.mat)) # fishery and area definitions are identical
...
fishery.substitution.mat <- matrix(paste0("DP.A", area.substitution.mat),ncol=ncol(area.substitution.mat)) # fishery and area definitions are identical
